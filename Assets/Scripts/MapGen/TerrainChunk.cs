...
public class TerrainChunk {
    ...
    public void SetItemsSpawned(bool flag)
    {
        hasItemsSpawned = flag;
    }
	...
	public void SetVisible(bool visible) {
		meshObject.gameObject.SetActive (visible);
	}

    public bool HasItemsSpawned()
    {
        return hasItemsSpawned;
    }
